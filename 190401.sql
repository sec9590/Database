...
-- 테이블 world.address_book 구조 내보내기
CREATE TABLE IF NOT EXISTS `address_book` (
  `no` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(10) NOT NULL,
  `gender` char(2) NOT NULL DEFAULT '남',
  `address` varchar(40) DEFAULT NULL,
  `tel` varchar(14) DEFAULT NULL,
  PRIMARY KEY (`no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.address_book:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 world.city:~0 rows (대략적) 내보내기
...
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	...
	(4080, 'Osan', 'KOR', 'Kyonggi', 201234),
	(4081, 'Pochon', 'KOR', 'Kyonggi', 156789);
...
-- 테이블 데이터 world.country:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 world.countrylanguage:~0 rows (대략적) 내보내기
...
-- 테이블 world.eagles 구조 내보내기
CREATE TABLE IF NOT EXISTS `eagles` (
  `back_no` int(4) NOT NULL,
  `name` varchar(10) NOT NULL,
  `position` varchar(14) DEFAULT NULL,
  `highschool` varchar(20) DEFAULT NULL,
  `throw_hand` varchar(10) DEFAULT NULL,
  `hit_hand` varchar(10) DEFAULT NULL,
  `birth` varchar(10) DEFAULT NULL,
  `salary` int(10) DEFAULT NULL,
  PRIMARY KEY (`back_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.eagles:~10 rows (대략적) 내보내기
/*!40000 ALTER TABLE `eagles` DISABLE KEYS */;
INSERT INTO `eagles` (`back_no`, `name`, `position`, `highschool`, `throw_hand`, `hit_hand`, `birth`, `salary`) VALUES
	(1, '하주석', '내야수', '신일고', '우투', '좌타', '940225', 180000000),
	(2, '김지수', '외야수', '유신고', '좌투', '좌타', '961029', 27000000),
	(8, '정근우', '외야수', '부산고', '우투', '우타', '821002', 700000000),
	(12, '김창혁', '포수', '부산고', '우투', '우타', '910517', 30000000),
	(13, '최재훈', '포수', '덕수고', '우투', '우타', '890827', 125000000),
	(19, '김재영', '투수', '서울고', '우투', '우타', '930722', 71000000),
	(22, '이태양', '투수', '효천고', '우투', '좌타', '900703', 150000000),
	(30, '호잉', '외야수', NULL, '우투', '좌타', '890518', 1585759000),
	(38, '안영명', '투수', '천안북일고', '우투', '우타', '841119', 350000000),
	(52, '김태균', '내야수', '천안북일고', '우투', '우타', '820529', 1500000000);
/*!40000 ALTER TABLE `eagles` ENABLE KEYS */;
